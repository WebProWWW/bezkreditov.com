...
<section class="section" style="position: relative; overflow: hidden; background: #FBCB5D;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>Каталог крупных и малоизвестных МФО и МКК в России</h1>
                <p class="em-11">
                    Полный список микрофинансовых и микрокредитных организаций России, выдающих займы онлайн с возможностью поиска, подробная информация о зарегистрированных в официальном реестре ЦБ РФ МФО, адреса и контактные телефоны.
                </p>
            </div><!-- .col -->
            <div class="col-12 col-md-6 align-self-end">
                <img class="img-center" width="480" src="/img/img-45.jpg" style="margin-bottom: -11px;">
            </div><!-- .col -->
        </div><!-- .row -->
    </div><!-- .container -->
</section><!-- .section -->
...
<section class="section bg">
    <div class="container">
        <div class="cart mb-4 p-lg-3">
            <div class="cart-body">
                <h2 class="h1">Займ онлайн — список микрофинансовых организаций</h2>
                <p>На «Без Кредитов» представлен актуальный каталог МФО России. Все организации зарегистрированы в официальном реестре ЦБ РФ и имеют лицензию на оказание услуг кредитования.</p>
                <p><strong>С помощью нашего каталога вы можете:</strong></p>
                <ul class="ul-circle">
                    <li><p>получить самую актуальную информацию о МФО или МФК;</p></li>
                    <li><p>изучить действующие предложения по микрозаймам организации;</p></li>
                    <li><p>взять займ онлайн;</p></li>
                    <li><p>найти контактные данные и адреса отделений;</p></li>
                    <li><p>увидеть реальные отзывы клиентов МФО.</p></li>
                </ul>
                <p>Мы заботимся о предоставлении только актуальной и достоверной информации, а поэтому постоянно обновляем каталог, добавляя новые микрофинансовые организации ежедневно, и обновляем данные об уже зарегистрированных МФК.</p>
            </div><!-- .cart-body -->
        </div><!-- .cart -->
    </div><!-- .container -->
</section><!-- .section -->