...
$this->params['breadcrumbs'] = ['Узнать свои долги г.&nbsp;' . $city->name];

$this->title = 'Проверка задолженности перед ФССП г. ' . $city->name;
...
<section class="section bg">
    <div class="container">
        <h1 class="center">Проверка задолженности перед ФССП г.&nbsp;<?= $city->name ?></h1>
    </div><!-- .container -->
</section><!-- .section -->
...
<section class="section">
    <div class="container">
        ...
        ></div>
        <!-- / VUE-APP-FSSP -->
        <p class="em-9">Нажимая кнопку «Получить информацию», вы принимаете условия <a href="javascript:;">Политики обработки персональных данных.</a></p>
