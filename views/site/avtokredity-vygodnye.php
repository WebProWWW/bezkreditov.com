...
$this->title = 'Самые выгодные автокредиты в банках России';
$this->params['description'] = 'Персональный подбор автокредита. Отправьте заявку и получите решение онлайн! Выгодные условия по автокредитам. Минимум документов.';
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>Самые выгодные автокредиты <br>в банках России</h1>
                <p class="em-11">Персональный подбор автокредита. Отправьте заявку и получите решение онлайн! Выгодные условия по автокредитам. Минимум&nbsp;документов.</p>
            </div><!-- .col -->
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Рекомендуем выгодный автокредит</h2>
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Подобрать автокредиты</h2>
        <p>Показано 20 автокредитов из 25 доступных</p>
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Последние отзывы об автокредитах</h2>
        <div class="cart">
            <div class="cart-body">
                <div class="row">
                    <div class="col-auto">
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Как оформить автокредит</h2>
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="cart">
                    <div class="cart-body center">
