...
<section class="section bg">
    <div class="container">
        <h2 class="h1 center px-xl-5">Закажите детализированный отчет о прохождении бесплатной процедуры банкротства</h2>
        <div class="cart">
            <div class="cart-body">
                <div class="row align-items-center">
                    <div class="col-12 col-lg order-lg-2 z-2">
                        <div class="px-sm-3 pl-lg-0">
                            ...
                            <div class="wall px-sm-5 mb-lg-4">
                                ...
                                <p class="em-11 my-3">Закажите детализированный отчет о прохождении бесплатной процедуры банкротства и получите предварительное решение о списании ваших долгов прямо на почту в течение 2&nbsp;-&nbsp;х&nbsp;часов</p>
                                <div class="row justify-content-center my-3">
                                    <div class="col-auto">
                                        <a class="btn btn-default" href="<?= Url::toView('bankrotstvo') ?>">Подробнее </a>
                                    </div><!-- .col -->
                                </div><!-- .row -->
                            </div><!-- .wall -->
...
<section class="section bg">
    <div class="container">
        ...
        <div class="row justify-content-center mb-3 js-tab-links">
            <div class="col-auto">
                <a class="tab-ln active" data-link="#block-company-slide-1" href="javascript:;">По количеству успешных дел</a>
            </div><!-- .col -->
            <div class="col-auto">
                <a class="tab-ln" data-link="#block-company-slide-2" href="javascript:;">По количеству отзывов</a>
            </div><!-- .col -->
            <div class="col-auto">
                <a class="tab-ln" data-link="#block-company-slide-3" href="javascript:;">По рейтингу</a>
            </div><!-- .col -->
        </div><!-- .row -->
        ...
        <div class="js-tab-contents">
            ...
            <div class="tab-content active" id="block-company-slide-1" style="opacity: 1">
                <div class="row">
            ...
            <?php /* @var $companies Company[] */ ?>
            <div class="tab-content" id="block-company-slide-2">
                <div class="row">
            ...
            <?php /* @var $companies Company[] */ ?>
            <div class="tab-content" id="block-company-slide-3">
                <div class="row">
