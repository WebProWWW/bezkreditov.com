    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md">
                <label class="label">Сумма кредитов, ₽</label>
                <input type="text" class="input" data-maskmoney value="500 000 ₽">
            </div><!-- .col -->
            <div class="col-12 col-md">
                <label class="label">Льготный период</label>
                <select class="input">
                    <option selected>Любой</option>
                    <option>от 0 мес.</option>
                    <option>от 1 мес.</option>
                    <option>от 2 мес.</option>
                    <option>от 3 мес.</option>
                    <option>от 4 мес.</option>
                    <option>от 5 мес.</option>
                    <option>от 6 мес.</option>
                    <option>от 7 мес.</option>
                    <option>от 8 мес.</option>
                    <option>от 9 мес.</option>
                    <option>от 10 мес.</option>
                    <option>от 11 мес.</option>
                    <option>от 12 мес.</option>
                </select>
            </div><!-- .col -->
