...
$this->title = 'Кредит На автомобиль от Альфа-Банка';
...
$this->params['breadcrumbs'] = [
    ...
    'Кредит «На&nbsp;автомобиль» от&nbsp;Альфа&nbsp;-&nbsp;Банка',
];
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>Кредит «На&nbsp;автомобиль» от&nbsp;Альфа&nbsp;-&nbsp;Банка</h1>
                <div class="row no-gutters align-items-center">
                    <div class="col-auto mr-2">
                        <img class="img img-circle" src="/img/logo/0.png">
                    </div>
                    <div class="col">
                        <p class="clip em-13">Альфа-банк</p>
                    </div>
                </div>
            </div><!-- .col -->
            ...
            <div class="col-12 col-md-4 col-lg-4 order-md-2">
                ...
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Обзор</a></p>
                    </div>
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Сравнить</a></p>
                    </div>
                    <div class="col-12 col-xl-12">
                        <p><a class="btn-default" href="javascript:;">Оформить автокредит</a></p>
                    </div>
                </div>
            </div><!-- .col -->
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Как получить автокредит</h2>
