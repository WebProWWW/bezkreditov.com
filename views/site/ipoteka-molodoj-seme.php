...
$this->title = 'Ипотека для молодой семьи';
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-5 col-xl-4">
                ...
                <p class="em-11">«Без кредитов» собрал лучшие предложения по ипотеке для молодой семьи с низкой процентной ставкой и моментальным одобрением</p>
            </div><!-- .col -->
