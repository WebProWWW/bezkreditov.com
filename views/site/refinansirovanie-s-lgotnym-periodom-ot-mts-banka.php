...
$this->title = 'Рефинансирование с льготным периодом от МТС - банка';
$this->params['description'] = 'Рефинансирование с льготным периодом от МТС - банка';
$this->params['breadcrumbs'] = [
    [
        'label' => 'Рефинансирование',
        'url' => ['site/index', 'view' => 'refinansirovanie-kredita'],
    ],
    '«Рефинансирование с льготным периодом» от&nbsp;МТС&nbsp;-&nbsp;банка',
];

?>
<section class="section" style="background: #FAB302; position: relative; overflow: hidden;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>«Рефинансирование с льготным периодом» от&nbsp;МТС&nbsp;-&nbsp;банка</h1>
                <div class="row no-gutters align-items-center">
                    <div class="col-auto mr-2">
                        <img class="img img-circle" src="/img/logo/0.jpeg">
                    </div>
                    <div class="col">
                        <p class="clip em-13">МТС Банк</p>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-12 col-md-6 align-self-end">
                <img class="img-center" width="400" src="/img/img-51.jpg" style="margin-bottom: -11px">
            </div><!-- .col -->
        </div><!-- .row -->
    </div><!-- .container -->
</section><!-- .section -->
            ...
            <div class="col-12 col-md-4 col-lg-4 order-md-2">
                ...
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Обзор кредита</a></p>
                    </div>
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Сравнить</a></p>
                    </div>
                    <div class="col-12 col-xl-12">
                        <p><a class="btn-default" href="javascript:;">Оформить кредит</a></p>
                    </div>
                </div>
            </div><!-- .col -->
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Как получить кредит</h2>
