...
<section class="section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 col-lg-4 order-md-4">
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Обзор карты</a></p>
                    </div>
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Сравнить</a></p>
                    </div>
                    <div class="col-12 col-xl-12">
                        <p><a class="btn-default" href="javascript:;">Оформить карту</a></p>
                    </div>
                </div>
            </div><!-- .col -->

            <div class="col-12 col-md-8 col-lg-8 order-md-3">
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-auto">
                <a class="btn-trsp btn-sm px-2 em-7" href="javascript:;">ЛЬГОТНЫЙ ПЕРИОД</a>
            </div>
            <div class="col-auto">
                <a class="btn-trsp btn-sm px-2 em-7" href="javascript:;">БЕСПЛАТНОЕ ОБСЛУЖИВАНИЕ</a>
            </div>
        </div><!-- .row -->
    </div><!-- .container -->
</section><!-- .section -->
...
<div class="container">
    <div class="row js-tab-links">
        ...
        <div class="col-auto">
            <a class="tab-ln" data-link="#card-desc-tab-4" href="javascript:;">Условия кредитования</a>
        </div><!-- .col -->
    </div><!-- .row -->
</div>
                    ...
                    <div class="cart-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-12">
                                <img class="img-center ml-sm-0 mb-1" width="320" src="/img/card-mts.png">
                                <p class="clip"><a href="javascript:;">Виртуальная кредитная карта Kviku</a></p>
                                <div class="row">
                                    <div class="col-12 col-xl">
                                        <p class="fw-600 mb-0">до 100 000 ₽</p>
                                        <p class="em-9 gray">Кредитный лимит</p>
                                    </div><!-- .col -->
                                    <div class="col-12 col-xl">
                                        <p class="fw-600 mb-0">до 50 месяцев</p>
                                        <p class="em-9 gray">Льготный период</p>
                                    </div><!-- .col -->
                                </div><!-- .row -->
                            </div><!-- .col -->

                            <div class="col-12 d-sm-none d-lg-block"><div class="divider"></div></div>

                            <div class="col-12 col-sm-6 col-lg-12">
                                <img class="img-center ml-sm-0 mb-1" width="320" src="/img/card-xalva.png">
                                <p class="clip"><a href="javascript:;">Карта рассрочки Халва</a></p>
                                <div class="row">
                                    <div class="col-12 col-xl">
                                        <p class="fw-600 mb-0">до 350 000 ₽</p>
                                        <p class="em-9 gray">Кредитный лимит</p>
                                    </div><!-- .col -->
                                    <div class="col-12 col-xl">
                                        <p class="fw-600 mb-0">до 1 080 месяцев</p>
                                        <p class="em-9 gray">Льготный период</p>
                                    </div><!-- .col -->
                                </div><!-- .row -->
                            </div><!-- .col -->
                        ...
                        <div class="row">
                            <div class="col-auto mx-auto">
                                <a class="btn-default" href="javascript:;">Все кредитные карты</a>
                            </div>
                        </div>
                    </div><!-- .cart-body -->
                </div><!-- .cart -->
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Как оформить карту</h2>
