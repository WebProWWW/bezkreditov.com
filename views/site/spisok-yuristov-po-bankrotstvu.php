...
<section class="section" style="background: #D9DEE1; overflow: hidden;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-md-5 order-2 order-md-1 align-self-end mx-auto">
                <img class="img-center" src="/img/img-4.jpg" style="margin-bottom: -13px">
            </div><!-- .col -->
            <div class="col-12 col-sm-9 col-md-7 col-xl-6 order-1 order-md-2 align-self-center">
