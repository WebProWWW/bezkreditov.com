...
$this->title = 'Ипотека без подтверждения дохода';
$this->params['description'] = '«Без кредитов» подобрал лучшие предложения по ипотеке без подтверждения доходу, ставкой от 2% годовых и быстрым решением';
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-5 col-xl-4">
                <h1>Ипотека без подтверждения дохода</h1>
                <p class="em-11">«Без кредитов» подобрал лучшие предложения по ипотеке без подтверждения доходу, ставкой от 2% годовых и быстрым решением</p>
            </div><!-- .col -->
