...
$this->title = 'Микрозайм еКапуста';
$this->params['description'] = 'Микрозайм еКапуста';
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>Микрозайм «еКапуста»</h1>
                <div class="row no-gutters align-items-center">
                    <div class="col-auto mr-2">
                        <img class="img img-circle" src="/img/logo/1.png">
                    </div>
                    <div class="col">
                        <p class="clip em-13">еКапуста»</p>
                    </div>
                </div>
            </div><!-- .col -->
        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-4 col-lg-4 order-md-2">
                <p class="h1">
                    ...
                    <span class="em-6 d-block">10 отзывов</span>
                </p>
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Обзор займа</a></p>
                    </div>
                    <div class="col-12 col-xl-6">
                        <p><a class="btn-trsp" href="javascript:;">Сравнить</a></p>
                    </div>
                    <div class="col-12 col-xl-12">
                        <p><a class="btn-default" href="javascript:;">Оформить займ</a></p>
                    </div>
                </div>
            </div><!-- .col -->
            
            <div class="col-12 col-md-8 col-lg-8 order-md-1">
                <p>Лицензия № 2120754001243 от 22.03.2012</p>
...
<section class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-auto">
                <a class="btn-trsp btn-sm px-2 em-7" href="javascript:;">ПРОЛОНГАЦИЯ</a>
            </div>
            <div class="col-auto">
                <a class="btn-trsp btn-sm px-2 em-7" href="javascript:;">ДОСРОЧНОЕ ПОГАШЕНИЕ</a>
            </div>
            <div class="col-auto">
                <a class="btn-trsp btn-sm px-2 em-7" href="javascript:;">БЕЗ ОБЕСПЕЧЕНИЯ</a>
            </div>
        </div><!-- .row -->
    </div><!-- .container -->
</section><!-- .section -->
                    ...
                    <div class="cart-body">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-sm-auto mx-auto ml-lg-0">
                                ...
                                <p class="gray em-9">Сумма займа</p>
                            </div><!-- .col -->
                            <div class="col-12 col-sm-auto">
                                <p class="fw-600 mb-0">от 36 мес.</p>
                                <p class="gray em-9">Срок займа</p>
                            </div><!-- .col -->
                        </div><!-- .row -->
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Как получить займ</h2>
