...
<section class="section">
    <div class="container">
        <p>Чтобы получить информацию об имеющихся задолженностях перед судебными приставами по исполнительным производствам необходимо заполнить форму ниже.</p>

        <div class="row">
            <div class="col-12 col-md-6 col-lg-auto">
                <label class="label mb-4 d-flex align-items-center">
                    <span class="d-block">
                        <input class="radio" type="radio" name="radio-1" checked>
                    </span>
        ...
        <div class="row">
            <div class="col-12 col-md-8 col-lg-6">
                <p class="em-13">Узнать задолженность по фамилии</p>
                ...
                <div class="row">
                    <div class="col-12 col-xl-7">
                        <button class="btn btn-default">Получить информацию</button>
                    </div>
                </div>
                ...
                <p>
                    ...
                    <br>
                    <strong>
                        <a class="ln-black-primary td-line" href="">Политики обработки персональных данных.</a>
                    </strong>
                </p>
            </div><!-- .col -->
        </div><!-- .row -->
