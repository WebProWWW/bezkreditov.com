...
$this->title = 'Кредит с плохой кредитной историей и просрочками';
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <h1>Кредит с плохой кредитной историей и просрочками</h1>
                <p class="em-11">
                    На &laquo;Без&nbsp;кредитов&raquo; представлены предложений от банков, готовых дать вам кредит даже с плохой кредитной историей и допущенными просрочками по прошлым обязательствам. Сравните предложения банков и подайте заявку онлайн на кредит с подходящими условиями.
                </p>
            </div><!-- .col -->
            <div class="col-12 col-md-6">
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Рекомендуем кредиты с испорченной кредитной историей</h2>
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Подобрать кредит с плохой КИ</h2>
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Отзывы о кредитах с плохой историей</h2>
        <div class="cart">
            <div class="cart-body">
                <div class="row">
                    <div class="col-auto">
...
<section class="section bg">
    <div class="container">
        <h2 class="h1">Сравнение кредитов с плохой кредитной историей</h2>
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="cart">
                    <div class="cart-body center">
...
<section class="section bg">
    <div class="container">
        <div class="cart mb-4 p-lg-3">
            <div class="cart-body">
                <p>Отсутствие информации в БКИ или низкий кредитный рейтинг негативным образом сказывается на вероятность одобрения банковской ссуды. Однако есть банки, в которых реально взять кредит с плохой кредитной историей и просрочками.</p>

                <h2 class="h1">Причины плохой кредитной истории</h2>

                <p><strong>Существует несколько причин, почему банки отказывают в получении ссуды:</strong></p>

                <ul class="ul-circle">
                    <li><p>несвоевременное погашение займов;</p></li>
                    <li><p>наличие текущих долгов без уважительных причин;</p></li>
                    <li><p>ежемесячный размер платежей составляет 50% и более от общего финансового дохода в семье;</p></li>
                    <li><p>несвоевременная передача информации в БКИ о закрытии договора;</p></li>
                    <li><p>перепродажа долговых обязательств коллекторским агентствам.</p></li>
                </ul>

                <p>Для некоторых организаций наличие испорченной кредитной истории не является основным фактором для отказа по заявке. В условиях жесткой конкурентной борьбы, многие кредитные организации стараются расширить клиентскую базу, поэтому готовы предоставить кредиты даже клиентам с испорченной КИ. Главное условие – это отсутствие незакрытых просрочек.</p>

                <h3 class="h1">Где взять кредит с плохой кредитной историей и просрочками?</h3>

                <p><strong>Самыми выгодными предложениями являются те, где отсутствует обязательное условие в оформлении залога или поручительства. Подавать заявку можно онлайн с помощью сайта &laquo;Без&nbsp;кредитов&raquo;. Для этого необходимо:</strong></p>

                <ul class="ul-circle">
                    <li><p>оценить предложенные условия на этой странице;</p></li>
                    <li><p>выбрать наиболее подходящие для себя условия;</p></li>
                    <li><p>перейти на сайт выбранного банка и оставить заявку-анкету на получение кредита.</p></li>
                </ul>
                <p>Если ваша заявка будет одобрена, то с вами свяжется менеджер выбранного банка и согласует дальнейшее получение денег. Получить одобренную сумму можно как на карту, так и наличными.</p>
            </div><!-- .cart-body -->
        </div><!-- .cart -->
    </div><!-- .container -->
</section><!-- .section -->
